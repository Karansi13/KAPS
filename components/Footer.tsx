...
const Footer = () => {
  return (
    <div className="mx-auto max-w-2xl px-4 sm:p-6 md:max-w-7xl">
      ...
      <div className="mx-auto p-4 mb-2 text-black text-center flex flex-col dark:text-neutral-100 md:flex-row md:justify-center">
        <div className="text-black dark:text-white mb-3">
          Made by{" "}
          <span className="font-bold text-gradient-1">Team Recursionist</span>
        </div>
